...
#define IS_IPHONE_X (IS_IPHONE && [[UIScreen mainScreen] bounds].size.height == 812.0f || [[UIScreen mainScreen] bounds].size.height == 896.0f)
...
#define IS_SEPERATION_ALERT [[NSUserDefaults standardUserDefaults] valueForKey:@"IS_SEPERATION_ALERT"]
#define IS_REPEAT_ALERT [[NSUserDefaults standardUserDefaults] valueForKey:@"IS_REPEAT_ALERT"]
