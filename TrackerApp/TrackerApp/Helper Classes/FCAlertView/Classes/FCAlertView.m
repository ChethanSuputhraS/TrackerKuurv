...
- (id)init
{
    ...
    if (self) {
        ...
        _flatTurquoise = global_greenColor;
        _flatGreen = global_greenColor;
        _flatBlue = global_greenColor;
        _flatMidnight = global_greenColor;
        _flatPurple = global_greenColor;
        _flatOrange = global_greenColor;
        _flatRed = global_greenColor;
        _flatSilver = global_greenColor;
        _flatGray = global_greenColor;
...
- (void) makeAlertTypeRateHearts:(FCRatingBlock)ratingBlock {
    ...
    self.colorScheme = global_greenColor;
}
