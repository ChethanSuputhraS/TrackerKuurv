...
-(id) init
{
    ...
    if (self)
    {
        ...
        _dataBasePath = [path stringByAppendingPathComponent:@"tracker.sqlite"];
...
- (NSString *) getDBPath
{
    ...
    return [documentsDir stringByAppendingPathComponent:@"tracker.sqlite"];
...
-(void)openDatabase
{
    ...
    if (!ok)
    {
        ...
        NSString *appPath = [[[NSBundle mainBundle] resourcePath]
                             stringByAppendingPathComponent:@"tracker.sqlite"];
    ...
    { // first time and database not copied
        ok = [self Create_UserAccount_Table]; // create empty database
        if (ok)
        {
...
-(BOOL)Create_UserAccount_Table
{
    ...
    NSArray* queries = [NSArray arrayWithObjects:@"CREATE TABLE 'UserAccount_Table' ('id' INTEGER PRIMARY KEY  NOT NULL, 'account_name' VARCHAR, 'user_email' VARCHAR, 'user_pw' VARCHAR,'google_id' VARCHAR,'fb_id' VARCHAR,'twitter_id' VARCHAR,'apple_id' VARCHAR,'is_social_login' VARCHAR,'device_token' VARCHAR,'user_unique_key' VARCHAR)",nil];
...
-(BOOL)Create_Device_Table
{
    ...
    // SQL to create new database
    NSArray* queries = [NSArray arrayWithObjects:@"CREATE TABLE 'Device_Table' ('id' INTEGER PRIMARY KEY  NOT NULL,'user_id' VARCHAR, 'ble_address' VARCHAR, 'device_name' VARCHAR, 'device_type' VARCHAR,'latitude' VARCHAR,'longitude' VARCHAR,'tracker_device_alert' VARCHAR,'marked_lost' VARCHAR,'is_active' VARCHAR,'contact_name' VARCHAR,'contact_email' VARCHAR,'contact_mobile' VARCHAR,'photo_localURL' VARCHAR,'photo_serverURL' VARCHAR,'identifier' VARCHAR,'created_time' VARCHAR,'updated_time' VARCHAR,'correction_status' VARCHAR,'is_sync' VARCHAR,'server_id' VARCHAR,'seperation_alert' VARCHAR,'repeat_alert' VARCHAR, 'volume' VARCHAR)",nil];
...
-(BOOL)Create_User_Set_Info
{
    ...
    // SQL to create new database
    NSArray* queries = [NSArray arrayWithObjects:@"CREATE TABLE 'User_Set_Info' ('id' INTEGER PRIMARY KEY  NOT NULL, 'user_id' VARCHAR, 'name' VARCHAR, 'email' VARCHAR,'mobile' VARCHAR)",nil];
