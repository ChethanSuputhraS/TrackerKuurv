...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        backView.alpha = 0.6;
        [[APP_DELEGATE window]addSubview:backView ];

        _boxView = [[UIView alloc] initWithFrame:CGRectMake(10, DEVICE_HEIGHT, DEVICE_WIDTH-20, 334)];
...
- (void)send:(id)sender
{
    ...
    if ([APP_DELEGATE validateEmail:_emailField.text])
    {
        ...
        {
            [[NSNotificationCenter defaultCenter] postNotificationName:@"DoorbellPopupNoInternet" object:nil];
            return;
        }
        [backView removeFromSuperview];
...
//    [_emailField setValue:[UIColor redColor] forKeyPath:@"_placeholderLabel.textColor"];
...
- (void)createBoxSubviews
{
    ...
    titleLabel.font = [UIFont fontWithName:CGBold size:txtSize+10];
    ...
    lblEmail.font = [UIFont fontWithName:CGRegular size:txtSize-2];
...
//    [_emailField setValue:[UIColor blackColor] forKeyPath:@"_placeholderLabel.textColor"];
    ...
    _emailField.font = [UIFont fontWithName:CGRegular size:txtSize];
    ...
    {
        _emailField.text = NSLocalizedString(CURRENT_USER_EMAIL, nil);
    }
    ...
    lblBody.font = [UIFont fontWithName:CGRegular size:txtSize-2];
    ...
    _bodyView.font = [UIFont fontWithName:CGRegular size:txtSize+2];
    ...
    _bodyPlaceHolderLabel = [[UILabel alloc] initWithFrame:CGRectMake(8.0f, 10.0f, boxWidth-40, 25.0f)];
    ...
    _bodyPlaceHolderLabel.font = [UIFont fontWithName:CGRegular size:txtSize];
    ...
    _cancelButton.backgroundColor = global_greenColor;
    [_cancelButton setTitle:NSLocalizedString(@"Cancel", nil) forState:UIControlStateNormal];
    [_cancelButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
    _cancelButton.titleLabel.font = [UIFont fontWithName:CGRegular size:txtSize];
    ...
    _sendButton.titleLabel.font = [UIFont fontWithName:CGRegular size:txtSize+2];
    _sendButton.backgroundColor = global_greenColor;
