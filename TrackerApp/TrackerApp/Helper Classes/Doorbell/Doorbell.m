...
-(void)thankyouMessage
{
    ...
    UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"Feedback" message:@"We appreciate your feedback!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
    [alert show];//Oneclick28-04-2016
}
-(void)ErrorMessage
{
