...
//        [theRequest setValue:@"application/json; charset=UTF-8;" forHTTPHeaderField:@"Content-Type"];
    ...
    [theRequest setValue:[[NSUserDefaults standardUserDefaults]valueForKey:@"CURRENT_USER_ACCESS_TOKEN"] forHTTPHeaderField:@"token"];
...
- (void)postUrlCallForMultipleImage:(NSString*)path withParameters:(NSMutableDictionary*)dictionary andMediaData:(NSMutableArray *)ArrMediaData andDataParameterName:(NSMutableArray *)ArrDataParameterName andFileName:(NSMutableArray *)ArrFileName;
{
    ...
    NSString *contentType = [NSString stringWithFormat:@"multipart/form-data; boundary=%@", BoundaryConstant];
    [request setValue:contentType forHTTPHeaderField: @"Content-Type"];
    [request setValue:[[NSUserDefaults standardUserDefaults]valueForKey:@"CURRENT_USER_ACCESS_TOKEN"] forHTTPHeaderField:@"token"];
